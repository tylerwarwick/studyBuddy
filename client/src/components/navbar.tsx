...
const NavLinkStyled = ({displayTag: displayTag, location: location} : NavLinkProps) =>{
    ...
    <li>
        <NavLink to={location} 
            ...
            isPending ? "pending" : (isActive ? 'bg-blue-500 md:bg-transparent md:text-blue-500 ' : '') + 'block py-2 pl-3 pr-4 rounded md:border-0 md:p-0 text-white md:hover:text-blue-500 hover:bg-gray-700 hover:text-white md:hover:bg-transparent'}> 
                    {displayTag} 
        </NavLink>
    </li>
    );
    ...
    <div className="sticky top-0 w-full">
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href={'/'} className="flex items-center">
                <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">StudyBuddy</span>
            </a>
            ...
            <div className={(hiding ? "hidden " : "") + "w-full md:block md:w-auto"} id="navbar-default" >
                <ul id='navbar' className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white bg-gray-800 md:bg-gray-900 border-gray-700">
                    {(user === null) ? (<>
