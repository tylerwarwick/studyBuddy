...
export default function Alert({dismissAlert: dismissAlert, message: message} : props){
    ...
    return(
        ...
        <button onClick={() => dismissAlert(false)} type="button" className="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 focus:ring-gray-400 p-1.5 inline-flex items-center justify-center h-8 w-8 bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white" data-dismiss-target="#alert-5" aria-label="Close">
