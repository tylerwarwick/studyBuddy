...
export default function CardRender({displayText : text, func : flip} : CardProps) {
    return (
        <a onClick={flip} data-testid='cardToggle' className="block w-full h-56 md:w-96 md:h-64 flex items-center py-6 justify-center whitespace-normal p-16 border rounded-lg shadow bg-gray-800 border-gray-700 hover:bg-gray-700 overflow-y-scroll no-scrollbar">
