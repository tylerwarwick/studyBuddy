        ...
        <div className="relative w-full max-w-2xl max-h-full">
            ...
            <div className="relative rounded-lg shadow border-2 border-gray-600 bg-gray-700">
                ...
                <div className="flex items-start justify-between p-4 border-b rounded-t border-gray-600">
                    ...
                    <button onClick={() => setHidden(true)} type="button" className="text-gray-400 bg-transparent rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center hover:bg-gray-600 hover:text-white" data-modal-hide="defaultModal">
            ...
            <form onSubmit={(event)=>{handleSubmit(event)}}>
                <div className="p-6 space-y-6">
                    ...
                    <textarea ref={questionRef} className="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" ></textarea>

                    <label className="block mb-2 text-sm font-medium text-white">Answer</label>
                    <textarea ref={answerRef} className="block p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"></textarea>
                ...
                <div className="flex items-center p-6 space-x-2 border-t rounded-b border-gray-600">
                    ...
                    <button onClick={() => setHidden(true)} type="button" className="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 bg-gray-700 text-gray-300 border-gray-500 hover:text-white hover:bg-gray-600 focus:ring-gray-600">Cancel</button>
                </div>
            </form>
